...
<title>Maklumat Diri | Digstry</title>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="breadcrumb-wrapper py-3 mb-4">
                <span class="text-muted fw-light">Tetapan Akaun /</span> Maklumat Pengguna
              </h4>
              ...
              <div class="row">
                <div class="col-md-12">
                  <ul class="nav nav-pills flex-column flex-md-row mb-3">
                    <li class="nav-item">
                      <a class="nav-link active" href="{{ url('/profile-user') }}"><i class="bx bx-user me-1"></i> Account</a>
                    </li>
                    <li class="nav-item">
                  ...
                  <div class="card mb-4">
                    <h5 class="card-header">Maklumat Pengguna</h5>
                    <!-- Account -->
                    <div class="card-body">
